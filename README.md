...
3. **Clone Repository**: `git clone https://github.com/ShubhamNisal/RetailStoreApp.git`
...
```bash
git clone https://github.com/ShubhamNisal/RetailStoreApp.git
...
# - Check GitHub Actions: https://github.com/ShubhamNisal/actions
